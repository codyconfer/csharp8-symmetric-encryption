...
namespace EncryptionDemo.EncryptionEngine
{
    ...
    /// Block Size: 128
    /// </summary>
    internal sealed class AesCryptKeeper : ISymmetricCryptKeeper
    {
        private byte[] _key;
        private byte[] _iv;

        public AesCryptKeeper()
        {
            HandleKeys();
        }
        ...
        /// </summary>
        //!TODO: Store/Retrieve keys in key vault here
        ...
        /// <summary>
        /// Create a properly configured AesManaged encryptor.
        /// </summary>
